(function () {
  ...
  const popupNotices = [
    ...
    { threshold: 0.33, title: "SYSTEM NOTICE", message: "The paragraph has exceeded its authorized shape." },
    { threshold: 0.38, title: "READABILITY NOTIFICATION", message: "The document is still legally readable." },
    { threshold: 0.54, title: "DOCUMENT INSPECTION", message: "A small amount of void has been detected near the operator." },
    { threshold: 0.57, title: "READABILITY REPORT", message: "The document is may still be readable. Please check the integrity of the text or contact the Operator.", damage: 1 },
